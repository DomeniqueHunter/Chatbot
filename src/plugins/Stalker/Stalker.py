...
class Stalker(Plugin_Prototype):
    ...
    def register_actions(self):
        if self.client:
            ...
            self.client.private_msg_handler.add_action("!stalker_list", self._get_full_client_list)
            
            
            self.client.owner_manpage.add_command("!stalker_list <channel>", "returns a list of all clients which where in the channel")
