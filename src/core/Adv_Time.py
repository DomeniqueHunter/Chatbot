...
class Adv_Time():
    ...
    def get_time_date(self):
        return Adv_Time.get_formated_time('%Y-%m-%d %H:%M:%S', self.get_time_s(), False)
    
    def get_time_formated(self, format):
        return Adv_Time.get_formated_time(format, self.get_time_s(), False)
    ...
    def get_delta_time(format_string, t1_s, t2_s):
        delta = t2_s - t1_s
        return Adv_Time.get_formated_time(format_string, delta, False)